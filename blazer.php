...
<link rel="stylesheet" href="css/sample.css">
    <h1 class="bh1">BLAZERS</h1>
    <div class="super1">
    <?php
        include("db.php");
        $sql = "SELECT * FROM products WHERE product_title='Blazer'";
        ...
        while ($row = mysqli_fetch_assoc($query)){
            ...
            echo'
                ...
                <div class="sub2">
                    ...
                    <p>Lapel: '.$row["product_d"].'</p>
                    <p>Button Style: '.$row["product_b"].'</p>
                    <p>Wash Instructions: '.$row["product_c"].'</p>
