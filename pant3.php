...
<link rel="stylesheet" href="css/sample.css">
    <h1 class="bh1">PATTERN PANTS</h1>
    <div class="super1">
    <?php
        include("db.php");
        $sql = "SELECT * FROM products WHERE product_title='Pattern-Pant'";
        ...
        while ($row = mysqli_fetch_assoc($query)){
            ...
            echo'
                ...
                <div class="sub2">
                    ...
                    <p>Style: '.$row["product_b"].'</p>
                    <p>Material: '.$row["product_c"].'</p>
                    <p>Size: '.$row["product_d"].'</p>
